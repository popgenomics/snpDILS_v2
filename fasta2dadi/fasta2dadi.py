...
def main(argv):
	...
	helpmessage += 'example: pypy3 fasta2dadi.py -i mytilus_renamed.fas -o coding_noOut_mussels.out -r coding # only 3rd coding position, without outgroup\n'
	helpmessage += 'example: pypy3 fasta2dadi.py -i mytilus_renamed.fas -o coding_out_mussels.out -r coding -s Lighthouse # only 3rd coding position, using Lighthouse as outgroup\n'
	helpmessage += 'example: pypy3 fasta2dadi.py -i mytilus_renamed.fas -o nonCoding_noOut_mussels.out -r noncoding # all positions, without outgroup\n'
	helpmessage += 'example: pypy3 fasta2dadi.py -i mytilus_renamed.fas -o nonCoding_out_mussels.out -r noncoding -s Lighthouse # all positions, using Lighthouse as outgroup\n\n'
