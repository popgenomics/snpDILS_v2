...
Na = [ 1.0 for i in range(nMultilocus) ]


if sys.argv[1] == "SC_1M_1N":
	# secondary contact
	# msms tbs 10000 -s tbs -I 2 tbs tbs 0 -m 1 2 tbs -m 2 1 tbs -n 1 tbs -n 2 tbs -eM tbs 0 -ej tbs 2 1 -eN tbs tbs
	# nsamtot nSNPs nsamA nsamB M12 M21 N1 N2 Tsc Tsplit Tsplit Na
	## Miration rates
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], M12[sim], M21[sim], N1[sim], N2[sim], Tsc[sim], Tsplit[sim], Tsplit[sim], Na[sim]))
...
if sys.argv[1] == "SC_2M_1N":
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], M12_vec[locus], M21_vec[locus], N1[sim], N2[sim], Tsc[sim], Tsplit[sim], Tsplit[sim], Na[sim]))
...
if sys.argv[1] == "AM_1M_1N":
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], N1[sim], N2[sim], Tam[sim], M12[sim], M21[sim], Tsplit[sim], Tsplit[sim], Na[sim]))
...
if sys.argv[1] == "AM_2M_1N":
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], N1[sim], N2[sim], Tam[sim], M12_vec[locus], M21_vec[locus], Tsplit[sim], Tsplit[sim], Na[sim]))
...
if sys.argv[1] == "IM_1M_1N":
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			# SC print("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}\t{12:.5f}\t{13:.5f}".format(nsam_tot[locus], nSNPs[locus], rho[locus], L[locus], nsamA[locus], nsamB[locus], M12_vec[locus], M21_vec[locus], N1_vec[locus], N2_vec[locus], Tsc[sim], Tsplit[sim], Tsplit[sim], Na_vec[locus]))
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], N1[sim], N2[sim], M12[sim], M21[sim], Tsplit[sim], Tsplit[sim], Na[sim]))
...
if sys.argv[1] == "IM_2M_1N":
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			# SC print("{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}\t{11:.5f}\t{12:.5f}\t{13:.5f}".format(nsam_tot[locus], nSNPs[locus], rho[locus], L[locus], nsamA[locus], nsamB[locus], M12_vec[locus], M21_vec[locus], N1_vec[locus], N2_vec[locus], Tsc[sim], Tsplit[sim], Tsplit[sim], Na_vec[locus]))
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}\t{9:.5f}\t{10:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], N1[sim], N2[sim], M12_vec[locus], M21_vec[locus], Tsplit[sim], Tsplit[sim], Na[sim]))
...
if sys.argv[1] == "SI_1N":
	...
	for sim in range(nMultilocus):
		...
		for locus in range(nLoci):
			print("{0}\t{1}\t{2}\t{3}\t{4:.5f}\t{5:.5f}\t{6:.5f}\t{7:.5f}\t{8:.5f}".format(nsam_tot[locus], nSNPs[locus], nsamA[locus], nsamB[locus], N1[sim], N2[sim], Tsplit[sim], Tsplit[sim], Na[sim]))
