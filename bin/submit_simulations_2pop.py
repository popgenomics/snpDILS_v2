...
tmp += "python {0}/priorgen_2pop.py {1} {2} {3} | java -jar {0}/msms3.2rc-b163.jar tbs {4} {5} | pypy {0}/mscalc_2pop_SFS.py {6}".format(binpath, model, nmultilocus, config_yaml, nmultilocus*nlocus, mscommand, outgroup)
