...
mscommand = ""
if "SI" in model:
	mscommand = "-s tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -ej tbs 2 1 -eN tbs tbs"
if "AM" in model:
	mscommand = "-s tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -ema tbs 2 0 tbs tbs 0 -ej tbs 2 1 -eN tbs tbs"
if "SC" in model:
	mscommand = "-s tbs -I 2 tbs tbs 0 -m 1 2 tbs -m 2 1 tbs -n 1 tbs -n 2 tbs -eM tbs 0 -ej tbs 2 1 -eN tbs tbs"
if "IM" in model:
	mscommand = "-s tbs -I 2 tbs tbs 0 -n 1 tbs -n 2 tbs -m 1 2 tbs -m 2 1 tbs -ej tbs 2 1 -eN tbs tbs"
if "PAN" in model:
	mscommand = "-s tbs -eN 0 tbs"
...
tmp += python + " {0}/priorgen_gof_2pop.py {1} {2} {3} {4} {5} | java -jar {0}/msms3.2rc-b163.jar tbs {6} {7} | pypy {0}/mscalc_2pop_SFS.py {8}".format(binpath, model, nmultilocus, posterior_file, modeBarrier, modePrior, nmultilocus*nlocus, mscommand, outgroup)
